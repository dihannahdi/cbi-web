    ...
    <div className="mx-auto max-w-md">
      <div className="rounded-2xl bg-white p-8">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#083F19]/10">
            <LogIn className="h-8 w-8 text-[#083F19]" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="mb-1.5 flex items-center gap-2 text-sm font-medium text-[#222]">
              <Lock className="h-4 w-4 text-[#083F19]" />
              Password
            </label>
            <input
              type="password"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[#083F19] py-3.5 text-base font-semibold text-white transition-colors hover:bg-[#0E5424] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading ? (
