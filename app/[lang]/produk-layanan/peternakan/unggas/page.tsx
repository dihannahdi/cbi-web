...
export async function generateMetadata({
  ...
  const seg = dict.products.livestockUnggas;
  ...
  return {
    ...
    alternates: {
      canonical: url,
      languages: {
        id: `${SITE_CONFIG.url}/id/produk-layanan/peternakan/unggas`,
        en: `${SITE_CONFIG.url}/en/produk-layanan/peternakan/unggas`,
      },
    },
    openGraph: {
      title: seg.metaTitle,
...
const COMMODITIES = [
  { key: "broiler", labelId: "Ayam Broiler", labelEn: "Broiler Chicken" },
  { key: "petelur", labelId: "Ayam Petelur", labelEn: "Layer Chicken" },
  { key: "bebek", labelId: "Bebek & Itik", labelEn: "Duck" },
  { key: "puyuh", labelId: "Puyuh", labelEn: "Quail" },
];

export default async function PeternakanUnggas({
  params,
}: {
  params: Promise<{ lang: Locale }>;
}) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: dict.nav.peternakanUnggas, item: `${baseUrl}/${lang}/produk-layanan/peternakan/unggas` },
    ],
  };
      ...
      <section>
        <ContainerSection>
          <h2 className="mb-12 text-center text-3xl font-bold lg:text-4xl">
            {lang === "id" ? "Komoditas Unggas yang Kami Layani" : "Poultry Commodities We Serve"}
          </h2>
            ...
            {COMMODITIES.map((c) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  {lang === "id"
                    ? "Konsultasikan kebutuhan probiotik & bioaktivator untuk peternakan Anda."
                    : "Consult your probiotic & bioactivator needs for your farm."}
                </p>
              </div>
            ))}
          </div>
        ...
        <ContainerSection>
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            {[
              ...
              { src: "/img/sections/case-study-unggas.webp", alt: lang === "id" ? "Studi Kasus Unggas" : "Poultry Case Study" },
            ].map((img, i) => (
          ...
          <div className="rounded-3xl bg-[#083F19] p-8 text-white md:p-16">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <h2 className="text-3xl lg:text-4xl">
                {lang === "id"
                  ? "Konsultasi Produk Unggas?"
                  : "Need Poultry Product Consultation?"}
              </h2>
