...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_CONFIG.url}/${lang}/produk-layanan/pertanian/simbios-pupuk-hayati-cair`,
      languages: {
        'id': `${SITE_CONFIG.url}/id/produk-layanan/pertanian/simbios-pupuk-hayati-cair`,
        'en': `${SITE_CONFIG.url}/en/produk-layanan/pertanian/simbios-pupuk-hayati-cair`,
      },
    },
    robots: {
      index: true,
...
export default async function SimbiosProductPage({
  ...
  const strapiData = await fetchStrapiProduct("simbios-pupuk-hayati-cair");
  ...
  const schemas = [
    ...
    generateImageObjectSchema({
      url: '/products/simbios/simbios-cover.webp',
      name: `SIMBIOS - ${lang === 'id' ? 'Pupuk Hayati Premium dengan Bio-Aktivasi' : 'Premium Biofertilizer with Bio-Activation'}`,
      caption: lang === 'id' 
        ? 'SIMBIOS Pupuk Hayati Premium - 5 Mikroba Benefisial Aktif'
        : 'SIMBIOS Premium Biofertilizer - 5 Active Beneficial Microbes',
      description: lang === 'id'
        ? 'Gambar produk SIMBIOS pupuk hayati premium bersertifikat dengan teknologi bio-aktivasi'
        : 'SIMBIOS premium biofertilizer product image, certified with bio-activation technology',
      width: 600,
      height: 600,
      encodingFormat: 'image/webp',
      representativeOfPage: true,
      keywords: ['simbios', 'pupuk hayati', 'biofertilizer', 'bio-aktivasi', 'centra biotech'],
    })
  ];
