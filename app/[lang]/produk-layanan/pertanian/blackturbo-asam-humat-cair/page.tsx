...
export async function generateMetadata({
  ...
  const strapiData = await fetchStrapiProduct("blackturbo-asam-humat-cair", lang);
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_CONFIG.url}/${lang}/produk-layanan/pertanian/blackturbo-asam-humat-cair`,
      languages: {
        'id': `${SITE_CONFIG.url}/id/produk-layanan/pertanian/blackturbo-asam-humat-cair`,
        'en': `${SITE_CONFIG.url}/en/produk-layanan/pertanian/blackturbo-asam-humat-cair`,
      },
    },
  };
}
...
export default async function BlackTurboPage({
  ...
  const strapiData = await fetchStrapiProduct("blackturbo-asam-humat-cair");
  ...
  const imageSchema = generateImageObjectSchema({
    ...
    caption: lang === 'id' 
      ...
      : 'BLACK TURBO Liquid Humic Acid - Premium Soil Conditioner',
    description: lang === 'id'
      ? 'Gambar produk BLACK TURBO asam humat cair dengan kandungan asam humat 52,37%'
      : 'BLACK TURBO liquid humic acid product image with 52.37% humic acid content',
    width: 600,
    height: 600,
    encodingFormat: 'image/webp',
    representativeOfPage: true,
    keywords: ['black turbo', 'asam humat', 'humic acid', 'pembenah tanah', 'centra biotech'],
  });
