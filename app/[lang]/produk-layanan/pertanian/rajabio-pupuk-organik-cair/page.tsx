...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'id': `${SITE_CONFIG.url}/id/produk-layanan/pertanian/rajabio-pupuk-organik-cair`,
        'en': `${SITE_CONFIG.url}/en/produk-layanan/pertanian/rajabio-pupuk-organik-cair`,
      },
    },
    robots: {
      index: true,
...
export default async function RajabioProductPage({
  ...
  const strapiData = await fetchStrapiProduct("rajabio-pupuk-organik-cair");
  ...
  const schemas = [
    ...
    // 8. ImageObject Schema for Product Image - Google Image License Metadata
    ...
    generateImageObjectSchema({
      ...
      caption: lang === 'id' 
        ...
        : 'RAJABIO Premium Liquid Organic Fertilizer - 1 Liter Package',
      description: lang === 'id'
        ? 'Gambar produk RAJABIO pupuk organik cair bersertifikat Kementan RI untuk meningkatkan hasil panen hingga 40%'
        : 'RAJABIO liquid organic fertilizer product image, certified by Indonesian Ministry of Agriculture to increase harvest up to 40%',
      width: 600,
      height: 600,
      encodingFormat: 'image/webp',
      representativeOfPage: true,
      keywords: ['rajabio', 'pupuk organik cair', 'liquid organic fertilizer', 'poc', 'centra biotech'],
    }),
    ...
    generateImageObjectSchema({
      ...
      caption: lang === 'id' 
        ...
        : 'RAJABIO - Best Liquid Organic Fertilizer in Indonesia',
      description: lang === 'id'
        ? 'Banner promosi RAJABIO pupuk organik cair untuk pertanian berkelanjutan Indonesia'
        : 'RAJABIO liquid organic fertilizer promotional banner for sustainable Indonesian agriculture',
      width: 1440,
      height: 500,
      encodingFormat: 'image/jpeg',
      representativeOfPage: false,
      keywords: ['rajabio', 'pupuk organik', 'organic fertilizer', 'sustainable agriculture', 'centra biotech'],
    }),
  ];
