...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'id': `${SITE_CONFIG.url}/id/produk-layanan`,
        'en': `${SITE_CONFIG.url}/en/produk-layanan`,
      },
    },
    openGraph: {
      title,
      description,
      url: `${SITE_CONFIG.url}/${lang}/produk-layanan`,
  ...
  try {
    ...
    const structuredDataArray = [
      generateWebPageSchema({
        ...
        url: `/${lang}/produk-layanan`,
      }),
      generateBreadcrumbSchema([
        { name: homeLabel, url: `/${lang}` },
        { name: breadcrumbLabel, url: `/${lang}/produk-layanan` },
      ]),
    ];
